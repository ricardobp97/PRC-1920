...
module.exports.getEscritor = async (id) => {
    var query = `SELECT ?nome ?sexo ?filmeEscritoId ?filmeEscritoNome ?filmeEscritoPopularidade ?filmeEscritoDataLancamento
    ?filmeProduzidoId ?filmeProduzidoNome ?filmeProduzidoPopularidade ?filmeProduzidoDataLancamento ?filmeRealizadoId
    ?filmeRealizadoNome ?filmeRealizadoPopularidade ?filmeRealizadoDataLancamento ?filmeId ?filmeNome
    ?filmePopularidade ?filmeDataLancamento ?personagemNome ?personagemId WHERE {
