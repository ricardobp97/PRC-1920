...
module.exports.getRealizador = async (id) => {
    var query = `SELECT ?nome ?sexo ?filmeRealizadoId ?filmeRealizadoNome ?filmeRealizadoPopularidade ?filmeRealizadoDataLancamento
    ?filmeId ?filmeNome ?filmePopularidade ?filmeDataLancamento ?personagemNome ?personagemId ?filmeProduzidoId ?filmeProduzidoNome
    ?filmeProduzidoPopularidade ?filmeProduzidoDataLancamento ?filmeEscritoId ?filmeEscritoNome
